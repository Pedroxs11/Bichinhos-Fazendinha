# Fontes de áudio reais — Bichinhos & Fazendinha

Objetivo: substituir todos os sons sintetizados por gravações reais, curtas e reconhecíveis dos animais.

## Regra de uso
- Priorizar domínio público ou CC0.
- Não usar imitação humana de animal.
- Não usar áudio apenas porque o título contém o nome do animal; ouvir/validar antes.
...
- Conteúdo: relincho de cavalo.
- Licença: domínio público.

### Ovelha
- Wikimedia Commons: `File:Sheep bleating.ogg`
- Conteúdo: ovelha balindo.
- Licença: domínio público (origem PDSounds, autor liberou para domínio público).

### Cabra
- Wikimedia Commons: `File:Herd of goats bleating.ogg`
- Conteúdo: cabras balindo.
- Licença: domínio público (origem PDSounds, autor liberou para domínio público).

### Pato
- Wikimedia Commons: `File:Ducks landing in water.ogg`
- Conteúdo: patos reais pousando na água; usar somente se o trecho contém vocalização clara o suficiente para o quiz.
