...
class AnimalStageView @JvmOverloads constructor(context:Context,attrs:AttributeSet?=null):FrameLayout(context,attrs){
    ...
    private var baseRotationY=-8f;private var idle:ObjectAnimator?=null;private var baseY=0f
    init{
        ...
        animal.apply{text="🐮";textSize=112f;gravity=Gravity.CENTER;elevation=18f;rotationY=baseRotationY;cameraDistance=resources.displayMetrics.density*8000f}
