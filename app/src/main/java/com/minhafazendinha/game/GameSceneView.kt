...
class GameSceneView(context: Context): View(context){
    var sceneMode="garden"; var onFarmAnimalTap:((String)->Unit)?=null; var onSceneActionTap:((String)->Unit)?=null; private val p=Paint(Paint.ANTI_ALIAS_FLAG)
